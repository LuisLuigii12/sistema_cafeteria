...
const ITEMS: NavItem[] = [
  ...
  },
  {
    href: '/cafeteria',
    label: 'Cafetería',
    icon: <><path d="M17 8h1a4 4 0 0 1 0 8h-1" /><path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z" /><line x1="6" y1="2" x2="6" y2="4" /><line x1="10" y1="2" x2="10" y2="4" /><line x1="14" y1="2" x2="14" y2="4" /></>,
  },
  {
    href: '/inventario',
    label: 'Inventario',
  ...
  },
  {
    href: '/ventas',
    label: 'Ventas',
    icon: <><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z" /><path d="M8 7h8M8 11h8M8 15h5" /></>,
  },
  {
    href: '/finanzas',
    label: 'Finanzas',
